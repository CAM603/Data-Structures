...
3. What is the difference between using an array vs. a linked list when 
   ...
   Removing a list element is o(n) because every element then needs to shift
   Adding element to linked list is o(n) because we need to get to the last element
"""
